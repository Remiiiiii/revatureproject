...
import { revaturelogo } from "../assets";
    ...
    >
      ...
      >
        <img
          src={revaturelogo}
          alt=""
          className="w-[300px] h-[106px] object-contain"
        />
        <p className={`${styles.paragraph} mt-4 max-w-[310px]`}>
          Facts speak for themselves. 96% get hired after completing training.
          Sart today! Start here.{" "}
        </p>
      </div>
      <div
          ...
          >
            ...
            <ul className="list-none mt-4">
              {footerLink.links.map((link, index) => (
                ...
                hover:text-orange cursor-pointer
    ...
    >
      <p
        className="font-poppins font-normal text-center
            text-[18px] leading-[27px] text-white"
      >
        2023 Revature Project. All Rights Reserved.
      </p>
